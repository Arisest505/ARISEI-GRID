     ...
     <div>
      ...
      <div>
        ...
        <input
          ...
          value={localData.fecha_incidencia}
          onChange={handleChange}
          className="w-full px-4 py-2 border rounded-lg"
        />
      ...
      <div>
        ...
        <select
          ...
          value={localData.estado_incidencia}
          onChange={handleChange}
      ...
      <div>
        ...
        <select
          name="confidencialidad_nivel"
          value={localData.confidencialidad_nivel}
          onChange={handleChange}
          className="w-full px-4 py-2 bg-white border rounded-lg"
        >
