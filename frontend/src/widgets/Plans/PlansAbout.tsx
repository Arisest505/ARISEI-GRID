        ...
        <div className="grid grid-cols-1 gap-6 px-2 mx-auto sm:grid-cols-2 lg:grid-cols-4 max-w-7xl">
          {plans.map((plan, idx) => (
            ...
            >
              ...
              <button
                className="w-full px-4 py-2 text-sm font-semibold text-white transition duration-300 rounded-lg shadow-sm bg-cyan-500 hover:bg-sky-600 hover:shadow-xl hover:scale-105"
                onClick={() => {
